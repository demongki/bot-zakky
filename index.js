...
//Modal Dikit Broh:v
DapKey = 'blablabla' //https://dapuhy-api.herokuapp.com
...
//MENU
                ...
                if (isLimit(sender)) return reply(dpa.limitend)
                if (isBanned) return reply(dpa.baned)
                ngonrona = await fetchJson('https://dapuhy-api.herokuapp.com/api/others/corona?negara=indonesia&apikey=${DapKey}')
...
　　　　if (!isOwner) return reply(dpa.ownerb)
				reply(dpa.wait) 
				anu = await fetchJson(`https://dapuhy-api.herokuapp.com/api/getapikey`) 
				jam = `「 RANDOM APIKEY 」 :\n\n${anu.apikey}`
				reply(jam)
				break
...
//ISLAM MENU
                ...
                if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				anu = await fetchJson(`https://dapuhy-api.herokuapp.com/api/islam/doaharian?apikey=${DapKey}`)
				teks = '=================\n'
...
//ANIME MENU
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/search/googleimage?query=fuutarou&apikey=${DapKey}`)
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/search/googleimage?query=itsuki&apikey=${DapKey}`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/search/googleimage?query=miku&apikey=${DapKey}`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/search/googleimage?query=nino&apikey=${DapKey}`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/search/googleimage?query=yotsuba&apikey=${DapKey}`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/search/googleimage?query=ichika&apikey=${DapKey}`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/search/googleimage?query=tanjiro&apikey=${DapKey}`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/search/googleimage?query=nezuko&apikey=${DapKey}`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/search/googleimage?query=zenitsu&apikey=${DapKey}`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/search/googleimage?query=giyu&apikey=${DapKey}`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/search/googleimage?query=sakonji&apikey=${DapKey}`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/search/googleimage?query=inosuke&apikey=${DapKey}`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/search/googleimage?query=shinobu&apikey=${DapKey}`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/search/googleimage?query=kanao&apikey=${DapKey}`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/search/googleimage?query=sayu&apikey=${DapKey}`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/search/googleimage?query=yoshida&apikey=${DapKey}`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/search/googleimage?query=airi&apikey=${DapKey}`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/search/googleimage?query=asami&apikey=${DapKey}`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/search/googleimage?query=hashimoto&apikey=${DapKey}`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/search/googleimage?query=yuzuha&apikey=${DapKey}`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/search/googleimage?query=eren&apikey=${DapKey}`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/search/googleimage?query=mikasa&apikey=${DapKey}`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/search/googleimage?query=armin&apikey=${DapKey}`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/search/googleimage?query=levi&apikey=${DapKey}`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/search/googleimage?query=bertholdt&apikey=${DapKey}`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/search/googleimage?query=erwin&apikey=${DapKey}`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/search/googleimage?query=reiner&apikey=${DapKey}`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/search/googleimage?query=annie&apikey=${DapKey}`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/search/googleimage?query=hanji&apikey=${DapKey}`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/search/googleimage?query=jean&apikey=${DapKey}`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/search/googleimage?query=connie&apikey=${DapKey}`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/search/googleimage?query=historia&apikey=${DapKey}`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/search/googleimage?query=sasha&apikey=${DapKey}`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/search/googleimage?query=grisha&apikey=${DapKey}`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/search/googleimage?query=dot&apikey=${DapKey}`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/search/googleimage?query=frieda&apikey=${DapKey}`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/search/googleimage?query=carla&apikey=${DapKey}`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/search/googleimage?query=marco&apikey=${DapKey}`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/search/googleimage?query=ymir&apikey=${DapKey}`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/search/googleimage?query=floch&apikey=${DapKey}`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/search/googleimage?query=anka&apikey=${DapKey}`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/search/googleimage?query=eld&apikey=${DapKey}`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/search/googleimage?query=rico&apikey=${DapKey}`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/search/googleimage?query=petra&apikey=${DapKey}`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/search/googleimage?query=ai&apikey=${DapKey}`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/search/googleimage?query=momoe&apikey=${DapKey}`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/search/googleimage?query=neiru&apikey=${DapKey}`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
				...
				if (isLimit(sender)) return reply(dpa.limitend)
				reply(dpa.wait)
				dapgz = await fetchJson(`https://dapuhy-api.herokuapp.com/api/search/googleimage?query=rika&apikey=${DapKey}`)
				dpuhyy = await getBuffer(dapgz.image)
				dp.sendMessage(from, dpuhyy, image, {quoted: freply})
				await limitAdd(sender)
				break
...
// CASE BUATAN ZAKKY
                ...
                reply(dpa.wait)
                link = args.join(' ')
                dppa = await fetchJson(`https://dapuhy-api.herokuapp.com/api/socialmedia/tiktokdownload?apikey=$(${DapKey})&url=${link}`)
...
// CASE BUATAN ZAKKY
                ...
                reply(dpa.wait)
                link = args[0]
                resultnya = await fetchJson(`https://api.lolhuman.xyz/api/instagram?url${link}&apikey=${LolKey}`)
                buffer = await getBuffer(resultnya.result)
                ...
                reply(dpa.wait)
                urlnye = args[0]
                davva = await fetchJson(`https://dapuhy-api.herokuapp.com/api/socialmedia/ytmp3?url=${urlnye}&apikey=${DapKey}`)
                gmteng = davva.result
                ...
                reply(dpa.wait)
                urlnye = args[0]
                davva = await fetchJson(`https://dapuhy-api.herokuapp.com/api/socialmedia/ytmp4?url=${urlnye}&apikey=${DapKey}`)
                gmteng = davva.result
                hehe = `Judul : ${gmteng.title}\nChannel : ${gmteng.channel}\nPublished : ${gmteng.published}\nViews : ${gmteng.views}`
                tamnel = await getBuffer(gmteng.thumb)
                dp.sendMessage(from, tamnel, image, {quoted: freply, caption: hehe})
