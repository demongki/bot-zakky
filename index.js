...
• ${prefix}nuliskanan2 <zakky>
• ${prefix}nuliskiri <zakky>
• ${prefix}nuliskiri2 <zakky>
...
case 'nuliskanan2':
                ...
                reply(dpa.wait)
                dpuhy = args.join(' ')
                dapuhy = await getBuffer(`https://hardianto-chan.herokuapp.com/api/nuliskiri?text=${dpuhy}&apikey=${Hardianto}`)
                ...
                reply(dpa.wait)
                dpuhy = args.join(' ')
                dapuhy = await getBuffer(`https://hardianto-chan.herokuapp.com/api/nuliskanan?text=${dpuhy}&apikey=${Hardianto}`)
                dp.sendMessage(from, dapuhy, image, {quoted: freply})
                await limitAdd(sender)
                } catch (e) {
				console.log(`Error :`, color(e,'red'))
